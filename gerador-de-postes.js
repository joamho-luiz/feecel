...
for (let posiccamho in postes) {
    ...
    // Outros atributos
        ...
        img.src = './imagens/curiosamente.jpg'
        ...
        foto.src = './imagens/'+ canais[postes[posiccamho][1]][2]
    ...
    section.appendChild(conteuhdo)
    conteuhdo.appendChild(iframe)
    conteuhdo.appendChild(textos)
    conteuhdo.appendChild(botomhes)
